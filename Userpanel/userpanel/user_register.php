...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('./istockphoto-1364075546-612x612.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form method="post" class="login100-form validate-form p-b-33 p-t-5">
					...
					<div class="actions">
						<button type="submit" name="submit" class="login100-form-btn">Register</button>
					</div>
    ...
    if(isset($_POST['submit'])){
        ...
        if($result->num_rows>0){
            while($rows =mysqli_fetch_assoc($result)){
                echo "<script>
                swal('Good job!', 'Login Your Account!', 'success')
                setTimeout(function(){
