		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form action="" method="post" class="login100-form validate-form p-b-33 p-t-5">
					...
					<input class="input100" type="text" name="userame" class="form-control" placeholder="Enter Your Username" />
					...
					<div class="container-login100-form-btn m-t-32">
						<button class="login100-form-btn mx-1" name="Register" type="button">
							<a href="doctor_register.php" class="login100-form-btn">Register</a>
						</button>
					</div>
					<div class="container-login100-form-btn m-t-32">
